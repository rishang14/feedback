  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-blue-900 focus-visible:ring-blue-900/50 focus-visible:ring-[0.7px] dark:focus-visible:border-blue-600 dark:focus-visible:ring-blue-300/50",
