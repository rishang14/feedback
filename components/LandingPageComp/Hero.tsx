...
export default function Hero() {
  return (
    <section className="relative w-full py-12 min-h-screen md:py-24 lg:py-32 overflow-hidden">
      <div className="absolute bg-neutral-950 inset-0 -z-10 bg-[linear-gradient(to_right,#333_1px,transparent_1px),linear-gradient(to_bottom,#333_1px,transparent_1px)] bg-[size:4rem_4rem] dark:bg-[linear-gradient(to_right,#222_1px,transparent_1px),linear-gradient(to_bottom,#222_1px,transparent_1px)]"></div>
